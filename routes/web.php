...
Route::post('editar','productController@editarProducto')->name('editar');

Route::post('modificar','productController@modificarProducto')->name('modificar');

Route::post('eliminar/{idproducto}','productController@eliminarProducto')->name('eliminar');
